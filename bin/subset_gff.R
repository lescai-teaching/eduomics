...
# Filter for proetin-coding transcripts on the specified chromosome
filtered_gff3 <- gff_data[
    gff_data$type == "transcript" &
    mcols(gff_data)$gene_type == "protein_coding" &
    seqnames(gff_data) == chromosome_of_interest
]
