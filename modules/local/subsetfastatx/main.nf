process SUBSETFASTATX {
    ...
    output:
    tuple val(meta), path ("${meta.id}_filtered_transcripts_novers_${meta.chromosome}.fasta"),    emit: filtered_txfasta
    ...
    """
    subset_fastatx.R ${meta.id} ${meta.chromosome} ${txfasta} ${transcript_data}
    ...
    """
    touch ${meta.id}_filtered_transcripts_novers_${meta.chromosome}.fasta
